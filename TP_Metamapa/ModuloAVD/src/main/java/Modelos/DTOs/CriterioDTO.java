...
public class CriterioDTO {
    ...
    public CriterioDTO(String titulo, String descripcion, Boolean contenido_multimedia, String categoria, LocalDate fecha_carga_desde, LocalDate fecha_carga_hasta, String lugar, LocalDate fecha_acontecimiento_desde, LocalDate fecha_acontecimiento_hasta, String origen_carga) {
        this.titulo = titulo;
